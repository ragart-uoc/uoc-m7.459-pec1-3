...
//     version 1.7.0
//     from Assets/ML-Agents/Trainings/FoxFrog/InputSettings/FoxFrogAgentControlActions.inputactions
//
...
public partial class @FoxFrogAgentControlActions: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @FoxFrogAgentControlActions()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""FoxFrogAgentControlActions"",
    ""maps"": [
        {
            ""name"": ""Agent"",
    ...
    {
        private @FoxFrogAgentControlActions m_Wrapper;
        public AgentActions(@FoxFrogAgentControlActions wrapper) { m_Wrapper = wrapper; }
