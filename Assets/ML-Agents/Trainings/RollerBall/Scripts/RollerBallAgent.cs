...
namespace M7459.ML_Agents.Trainings.RollerBall.Scripts
{
    /// <summary>
    /// Class <c>RollerBallAgent</c> is a class that represents the RollerBall agent.
    /// </summary>
    public class RollerBallAgent : Agent
    {
        ...
        /// <summary>
        /// Method <c>OnTriggerStay</c>  is called almost all the frames for every Collider other that is touching the trigger.
        /// </summary>
        /// <param name="col">The other Collider involved in the collision.</param>
