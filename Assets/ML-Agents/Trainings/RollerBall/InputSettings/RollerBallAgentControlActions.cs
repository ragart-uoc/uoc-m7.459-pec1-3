...
//     version 1.7.0
//     from Assets/ML-Agents/Trainings/RollerBall/InputSettings/RollerBallAgentControlActions.inputactions
//
...
public partial class @RollerBallAgentControlActions: IInputActionCollection2, IDisposable
{
    public InputActionAsset asset { get; }
    public @RollerBallAgentControlActions()
    {
        asset = InputActionAsset.FromJson(@"{
    ""name"": ""RollerBallAgentControlActions"",
    ""maps"": [
        {
            ""name"": ""Agent"",
    ...
    {
        private @RollerBallAgentControlActions m_Wrapper;
        public AgentActions(@RollerBallAgentControlActions wrapper) { m_Wrapper = wrapper; }
