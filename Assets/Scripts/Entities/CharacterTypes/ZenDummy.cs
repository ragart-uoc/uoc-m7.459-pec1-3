...
{
    /// <summary>
    /// Class <c>ZenDummy</c> is the class for the ZenDummy character type.
    /// </summary>
    public class ZenDummy : ICharacterType
    {
        /// <value>Property <c>Character</c> represents the character.</value>
        private readonly Character _character;

        /// <summary>
        /// Class constructor <c>ZenDummy</c> initializes the class.
        /// </summary>
        /// <param name="character">The character.</param>
        public ZenDummy(Character character)
        {
        ...
        public void Follow()
        {
            if (_character.CurrentState == _character.CharacterStates[CharacterProperties.States.Following])
                return;
            _character.CurrentState = _character.CharacterStates[CharacterProperties.States.Following];
        ...
        {
            // ZenDummys don't need to handle collisions
        }
        ...
        {
            // ZenDummys don't need to handle triggers
        }
    }
}
